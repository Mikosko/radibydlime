...
Do not pre-build workshop or sale systems, before/after blocks, editors, authentication, commerce, or an extensive component library. Do not create implementation directories for hypothetical features.
