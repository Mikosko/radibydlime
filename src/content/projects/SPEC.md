...
`entrance-door.mdoc` remains explicitly labeled sample narrative and now uses a published media-catalog hero. The local SVG remains available for local-image build fixtures.
