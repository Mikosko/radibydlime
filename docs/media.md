...
Live publication was verified on 2026-09-11: the first approved image passed FTPS readback and public HTTPS checksum verification, its catalog record and processed receipt matched, and a repeat upload published no additional items. Full validation passed all 42 tests, type checks, the static build and formatting.
